...
public class ConfigurationManager implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6570065939095657993L;
	...
	public Database getDatabase( String strConfig, boolean asSigner){
		...
		try{
			...
			Document docConfig =  getDocument(strConfig);
			System.out.println("CONFIG " + strConfig + "; " + docConfig.toString());
...
System.out.println(session.getEffectiveUserName() + " - " + dbReturn.getTitle());
		}catch(Exception e){
			oLog.logException(e);			
		}	
